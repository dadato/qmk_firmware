 ...
 * The SK32 native interrupt-driven master I2C driver is selected through
 * the SK32_I2C_USE_I2C1 switch (the shared STM32 I2Cv1/I2Cv2 LLDs are not
 * part of this platform).
 *
 * I2C1 EEPROM test:
 *  - I2C1 master at 100kHz (standard mode) on PB6 (I2C1_SCL, alternate 13)
 *    and PB7 (I2C1_SDA, alternate 13), open drain outputs.
 */
