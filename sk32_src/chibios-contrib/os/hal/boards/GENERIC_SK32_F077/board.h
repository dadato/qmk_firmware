...
/*
 * Setup for the generic SK32F077 board.
 * The SK32F0xx family is register-compatible with the STM32F072 except for
 * the USB IP (SK32F077: Mentor-MUSB-class musbfsfc controller).
 */

/*
 * Board identifier.
 */
#define BOARD_GENERIC_SK32_F077
#define BOARD_NAME                  "3Think SK32F077 generic board"

/*
 * Board oscillators-related settings.
 * NOTE: LSE not fitted, the SK32 system clock is generated from the internal
 * HSI oscillator through the main PLL by the SK32 clock driver (mcuconf.h).
 */
#if !defined(SK32_LSECLK)
#define SK32_LSECLK                 0U
#endif

#define SK32_LSEDRV                 (3U << 3U)

#if !defined(SK32_HSECLK)
#define SK32_HSECLK                 8000000U
#endif
